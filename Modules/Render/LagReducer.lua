...
registerModule("Render", "Lag Reducer", 440, 50, true, S.GraphicsReducer, function(v) toggleGraphicsReducer(v); saveConfig() end, function(drawer) addSliderOption(drawer, "FPS Limit Cap", 15, 360, S.FPSCap, function(v) S.FPSCap = v; pcall(function() if setfpscap then setfpscap(v) end end); saveConfig() end) end, false)
